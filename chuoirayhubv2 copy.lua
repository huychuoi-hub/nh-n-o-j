...
local Window = Library:Window({
    ...
    SubTitle = "by hellcun.vn",
    })

local InfoTab = Window:NewPage({Title = "Tab | Discord"})
local ServerTab = Window:NewPage({Title = "Tab | Trạng Thái & Server"})
local SettingsTab = Window:NewPage({Title = "Tab | Cài Đặt"})
local HoldAndSkillTab = Window:NewPage({Title = "Tab | Kỹ Năng"})
local SeaSettingsTab = Window:NewPage({Title = "Tab | Cài Đặt Biển"})
local ShopTab = Window:NewPage({Title = "Tab | Cửa Hàng"})
local MainTab = Window:NewPage({Title = "Tab | Farm Chính"})
local MultiFarmTab = Window:NewPage({Title = "Tab | Multi Farm"})
local OthersTab = Window:NewPage({Title = "Tab | Khác"})
local FarmingHopTab = Window:NewPage({Title = "Tab | Farm & Hop"})
local FruitTab = Window:NewPage({Title = "Tab | Trái Cây"})
local RaidTab = Window:NewPage({Title = "Tab | Raid"})
local DungeonTab = Window:NewPage({Title = "Tab | Ngục Tối"})
local CombatTab = Window:NewPage({Title = "Tab | PvP"})
local RaceTab = Window:NewPage({Title = "Tab | Chủng Tộc"})
local DragonDojoTab = Window:NewPage({Title = "Tab | Dragon Dojo"})
local SeaEventTab = Window:NewPage({Title = "Tab | Sự Kiện Biển"})
local SeaStackTab = Window:NewPage({Title = "Tab | Đảo"})
local EspTab = Window:NewPage({Title = "Tab | ESP"})
local TeleportTab = Window:NewPage({Title = "Tab | Dịch Chuyển"})
local LocalPlayerTab = Window:NewPage({Title = "Tab | Nhân Vật"})
local StatsTab = Window:NewPage({Title = "Tab | Chỉ Số"})
local MiscTab = Window:NewPage({Title = "Tab | Tiện Ích"})
