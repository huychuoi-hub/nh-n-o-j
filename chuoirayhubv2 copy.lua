...
local T1UIColor = {
	["Border Color"] = Color3.fromRGB(180, 225, 255),          -- Xanh biển nhạt cho viền
	["Click Effect Color"] = Color3.fromRGB(220, 245, 255),    -- Hiệu ứng nhấn rất nhạt
	["Setting Icon Color"] = Color3.fromRGB(130, 200, 255),    -- Icon cài đặt xanh dịu
	["Logo Image"] = "rbxassetid://129713974430897",
	["Search Icon Color"] = Color3.fromRGB(130, 200, 255),
	["Search Icon Highlight Color"] = Color3.fromRGB(180, 230, 255),
	["GUI Text Color"] = Color3.fromRGB(50, 80, 110),          -- Chữ màu xanh xám đậm để dễ nhìn trên nền nhạt
	["Text Color"] = Color3.fromRGB(50, 85, 120),
	["Placeholder Text Color"] = Color3.fromRGB(150, 180, 210),
	["Title Text Color"] = Color3.fromRGB(100, 180, 240),      -- Tiêu đề xanh biển nhạt
	["Background Main Color"] = Color3.fromRGB(245, 252, 255), -- Nền chính gần như trắng xanh
	["Background 1 Color"] = Color3.fromRGB(235, 248, 255),    -- Các lớp nền phụ nhạt 75%
	["Background 1 Transparency"] = 0,
	["Background 2 Color"] = Color3.fromRGB(220, 242, 255),
	["Background 3 Color"] = Color3.fromRGB(230, 245, 255),
	["Background Image"] = "",
	["Page Selected Color"] = Color3.fromRGB(180, 220, 255),   -- Màu khi chọn Tab
	["Section Text Color"] = Color3.fromRGB(80, 140, 200),
	["Section Underline Color"] = Color3.fromRGB(150, 210, 255),
	["Toggle Border Color"] = Color3.fromRGB(170, 215, 255),
	["Toggle Checked Color"] = Color3.fromRGB(100, 190, 255),  -- Nút gạt khi bật
	["Toggle Desc Color"] = Color3.fromRGB(120, 150, 180),
	["Button Color"] = Color3.fromRGB(140, 205, 255),          -- Nút bấm xanh pastel
	["Label Color"] = Color3.fromRGB(245, 250, 255),
	["Dropdown Icon Color"] = Color3.fromRGB(120, 180, 240),
	["Dropdown Selected Color"] = Color3.fromRGB(180, 225, 255),
	["Dropdown Selected Check Color"] = Color3.fromRGB(100, 180, 255),
	["Textbox Highlight Color"] = Color3.fromRGB(190, 230, 255),
	["Box Highlight Color"] = Color3.fromRGB(190, 230, 255),
	["Slider Line Color"] = Color3.fromRGB(210, 235, 255),
	["Slider Highlight Color"] = Color3.fromRGB(120, 190, 255),
...
-- Load Library từ GitHub
local Library
local ok, err = pcall(function()
	Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/huychuoi-hub/main/refs/heads/main/Library.lua"))()
end)
if not ok or not Library then
	warn("[OVERLORDhub] Không load được Library: " .. tostring(err))
	return
end
...
local Window = Library:CreateWindow({
    ...
    SubTitle = "",
    SaveFolder = "data.json",
    Image = "rbxassetid://129713974430897"
})
...
InfoTab:AddSection(" OVERLORD Hub ");
