if getgenv().Nousigi then 
	if game.CoreGui:FindFirstChild(" Hub GUI") then
		for i, v in ipairs(game.CoreGui:GetChildren()) do
			if string.find(v.Name,  " Hub") then
				v:Destroy()
			end
		end
	end
...
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/huychuoi-hub/main/refs/heads/main/Library.lua"))()

local Window = Library:Window({
    Title = "OVERLORDhub - Blox Fruit",
    SubTitle = "",
    })

local InfoTab = Window:NewPage({Title = "Tab | Discord", Desc = "Discord & Thông Tin Hub", Icon = 6031280882})
local ServerTab = Window:NewPage({Title = "Tab | Trạng Thái & Server", Desc = "Trạng thái server & player", Icon = 6022668888})
local SettingsTab = Window:NewPage({Title = "Tab | Cài Đặt", Desc = "Cấu hình script", Icon = 6034509993})
local HoldAndSkillTab = Window:NewPage({Title = "Tab | Kỹ Năng", Desc = "Hold & Skill Combat", Icon = 6034685533})
local SeaSettingsTab = Window:NewPage({Title = "Tab | Cài Đặt Biển", Desc = "Cài đặt theo từng biển", Icon = 6034509993})
local ShopTab = Window:NewPage({Title = "Tab | Cửa Hàng", Desc = "Mua vật phẩm tự động", Icon = 6022668888})
local MainTab = Window:NewPage({Title = "Tab | Farm Chính", Desc = "Farm cấp độ & thành thục", Icon = 6031071532})
local MultiFarmTab = Window:NewPage({Title = "Tab | Multi Farm", Desc = "Farm nhiều tính năng cùng lúc", Icon = 6031071532})
local OthersTab = Window:NewPage({Title = "Tab | Khác", Desc = "Raid nhà máy, rương kho báu...", Icon = 6034685533})
local FarmingHopTab = Window:NewPage({Title = "Tab | Farm & Hop", Desc = "Farm boss & hop server", Icon = 6031071532})
local FruitTab = Window:NewPage({Title = "Tab | Trái Cây", Desc = "Tìm & ăn trái ác quỷ", Icon = 6022668888})
local RaidTab = Window:NewPage({Title = "Tab | Raid", Desc = "Auto Raid đảo", Icon = 6034685533})
local DungeonTab = Window:NewPage({Title = "Tab | Ngục Tối", Desc = "Auto Dungeon", Icon = 6034685533})
local CombatTab = Window:NewPage({Title = "Tab | PvP", Desc = "Chiến đấu người chơi", Icon = 6034685533})
local RaceTab = Window:NewPage({Title = "Tab | Chủng Tộc", Desc = "Nâng cấp chủng tộc", Icon = 6022668888})
local DragonDojoTab = Window:NewPage({Title = "Tab | Dragon Dojo", Desc = "Auto Dragon Dojo", Icon = 6034685533})
local SeaEventTab = Window:NewPage({Title = "Tab | Sự Kiện Biển", Desc = "Sự kiện trên biển", Icon = 6031071532})
local SeaStackTab = Window:NewPage({Title = "Tab | Đảo", Desc = "Quản lý đảo", Icon = 6022668888})
local EspTab = Window:NewPage({Title = "Tab | ESP", Desc = "Hiển thị ESP player/mob", Icon = 6034685533})
local TeleportTab = Window:NewPage({Title = "Tab | Dịch Chuyển", Desc = "Teleport đến địa điểm", Icon = 6031280882})
local LocalPlayerTab = Window:NewPage({Title = "Tab | Nhân Vật", Desc = "Chỉnh sửa nhân vật", Icon = 6022668888})
local StatsTab = Window:NewPage({Title = "Tab | Chỉ Số", Desc = "Phân bổ điểm chỉ số", Icon = 6034685533})
local MiscTab = Window:NewPage({Title = "Tab | Tiện Ích", Desc = "Các tiện ích hữu ích", Icon = 6022668888})
...
task.delay(2, function()
	...
	Library:Notify({Title = "OVERLORD Hub", Content = "Script đã tải! Chào mừng, " .. game.Players.LocalPlayer.Name, Icon = "star", Duration = 5});
end);

-- ══════════════════════════════════════
-- HELPERS & SETTINGS (definiti prima dei tab)
-- ══════════════════════════════════════
_G.Settings = {
	Main = {
		["Select Weapon"] = "Melee",
...
-- TAB CONTENT
-- ══════════════════════════════════════
InfoTab:Section(" OVERLORD Hub ");
InfoTab:Paragraph({
	Title = "OVERLORD Hub",
	Desc = "Phiên bản: R6.1 | Game: Blox Fruits\nDành cho cộng đồng OVERLORD Hub\nTất cả tính năng đều miễn phí."
});
InfoTab:Paragraph({
	Title = " Discord Server",
	Desc = "Tham gia cộng đồng để cập nhật, hỗ trợ và nhiều hơn!\nLink:discord.gg/MFbbstggwj"
});
InfoTab:Button({
	Title = "Tham Gia Discord OVERLORD Hub",
	Desc = "Nhấn để mở link mời Discord",
	Callback = function()
		setclipboard("https://discord.gg/MFbbstggwj");
		Library:Notify({Title = "OVERLORD Hub", Content = "Đã sao chép link Discord!\ndiscord.gg/MFbbstggwj", Icon = "bell", Duration = 5});
	end
});
InfoTab:Paragraph({
	Title = " Credits",
	Desc = "Dev: hellocun\nOwner:Veltrixians\n\nOVERLORD Hub R6.1 - Blox Fruits"
});

-- SEA 1 FARMS
FarmingHopTab:Section("🌊 Farm Biển 1");

local _FHAutoSaw = (_G.Settings and _G.Settings.FarmHop and _G.Settings.FarmHop["Auto Saw Sword"]) or false;
FarmingHopTab:Toggle({
...
-- SEA 2 FARMS
FarmingHopTab:Section("🌊 Farm Biển 2");
...
-- SEA 3 FARMS
FarmingHopTab:Section("🌊 Farm Biển 3");
...
FarmingHopTab:Section("⚙️ Farm Vật Liệu");
FarmingHopTab:Toggle({
...
MainSection = MainTab:Section("Main");
GameTimeParagraph = MainTab:Paragraph({
...
LevelFarmSection = MainTab:Section("⬆️ Farm Cấp Độ");
...
MainTab:Dropdown({
	...
	List = {"Level", "Bone", "Cake Prince", "Tyrant Of The Skies", "Nearest"},
	Value = "Level",
	Callback = function(v)
...
AutoLevelFarmToggle = MainTab:Toggle({
	Title = "Bắt Đầu Farm",
...
MasteryFarmSection = MainTab:Section("Farm Thành Thục");
if World3 then
	MasteryMethodList = {
		"Quest",
		"No Quest",
...
MasteryMethodDropdown = MainTab:Dropdown({
...
AutoFruitMasteryToggle = MainTab:Toggle({
...
AutoGunMasteryToggle = MainTab:Toggle({
...
ChooseSwordDropdown = MainTab:Dropdown({
	Title = "Chọn Kiếm",
	Values = SwordList,
...
AutoSwordMasteryToggle = MainTab:Toggle({
...
MonFarmSection = MainTab:Section("Farm Quái");
if World1 then
	tableMon = {
		"Bandit",
		"Monkey",
...
ChooseMonDropdown = MainTab:Dropdown({
	Title = "Chọn Quái",
	Values = tableMon,
...
AutoMonFarmToggle = MainTab:Toggle({
...
BossSection = FarmingHopTab:Section("👊 Farm Boss");
BossStatusParagraph = FarmingHopTab:Paragraph({
...
ChooseBossDropdown = FarmingHopTab:Dropdown({
	Title = "Chọn Boss",
	Values = tableBoss,
...
AutoFarmBossToggle = FarmingHopTab:Toggle({
...
AutoFarmAllBossToggle = FarmingHopTab:Toggle({
...
FactoryRaidSection = OthersTab:Section("Raid Nhà Máy");
_G.Settings.Farm["Tự Động Raid Nhà Máy"] = _G.Settings.Farm["Tự Động Raid Nhà Máy"] or false;
AutoFactoryRaidToggle = OthersTab:Toggle({
...
PirateRaidSection = OthersTab:Section("Raid Cướp Biển");
AutoPirateRaidToggle = OthersTab:Toggle({
...
ChestFarmSection = OthersTab:Section("Farm Rương Kho Báu");
...
MultiFarmTab:Section("DUNGEON KAITUN");
...
local _AutoFullyDungeonToggle = MultiFarmTab:Toggle({
	Title = "Auto Fully Dungeon",
...
AutoFarmChestTweenToggle = OthersTab:Toggle({
	...
	while true do
		...
		pcall(function()
			...
			if _isSpecialChestItem() then
				...
				Library:Notify({Title = "OVERLORD Hub", Content = "Item especial encontrado! Auto Chest parado.", Icon = "bell", Duration = 6});
				return;
			end;
			...
			for _, entry in ipairs(chests) do
				...
				if _isSpecialChestItem() then
					_chestTweenActive = false;
					_G.Settings.Farm["Auto Farm Chest Tween"] = false;
					Library:Notify({Title = "OVERLORD Hub", Content = "Item especial encontrado!", Icon = "bell", Duration = 6});
					break;
				end;
			...
			if _G.ChestHopActive and _G.ChestHopCount >= _G.ChestHopLimit then
				_G.ChestHopCount = 0;
				Library:Notify({Title = "OVERLORD Hub", Content = "Chest Hop: limite atingido, trocando server...", Icon = "bell", Duration = 4});
				task.wait(2);
				local module = (loadstring(game:HttpGet("https://raw.githubusercontent.com/raw-scriptpastebin/FE/main/Server_Hop_Settings")))();
				module:Teleport(game.PlaceId);
			end;
...
AutoFarmChestInstantToggle = OthersTab:Toggle({
	...
	while true do
		...
		pcall(function()
			...
			if _isSpecialChestItem() then
				...
				Library:Notify({Title = "OVERLORD Hub", Content = "Item especial encontrado! Chest Bypass parado.", Icon = "bell", Duration = 6});
				return;
			end;
		...
		if _G.ChestHopActive and _G.ChestHopCount >= _G.ChestHopLimit then
			_G.ChestHopCount = 0;
			Library:Notify({Title = "OVERLORD Hub", Content = "Chest Hop: trocando server...", Icon = "bell", Duration = 4});
			task.wait(2);
			local module = (loadstring(game:HttpGet("https://raw.githubusercontent.com/raw-scriptpastebin/FE/main/Server_Hop_Settings")))();
			module:Teleport(game.PlaceId);
		end;
...
AutoStopItemsToggle = OthersTab:Toggle({
...
CakePrinceSection = OthersTab:Section("Cake Prince");
CakePrinceStatusParagraph = OthersTab:Paragraph({
...
AutoKatakuriToggle = OthersTab:Toggle({
	Title = "Auto Katakuri",
...
AutoSpawnCakePrinceToggle = OthersTab:Toggle({
...
AutoKillCakePrinceToggle = OthersTab:Toggle({
...
AutoKillDoughKingToggle = OthersTab:Toggle({
...
MaterialsSection = MainTab:Section("Materials");
if World1 then
	MaterialList = {
		"Magma Ore",
		"Angel Wings",
...
MaterialDropdown = MainTab:Dropdown({
...
AutoFarmMaterialToggle = MainTab:Toggle({
...
local function ShowResetConfirm()
	pcall(function()
		...
		simBtn.MouseButton1Click:Connect(function()
			...
			Library:Notify({Title = "OVERLORD Hub", Content = "Settings resetados! Reexecute o script.", Icon = "bell", Duration = 6});
		end);
...
SettingsSection = SettingsTab:Section("Settings");
-- Choose Weapon (movido do Main para Settings)
SettingsTab:Section("Weapon");
local WeaponList = {"Melee","Sword","Fruit","Gun"};
ChooseWeaponDropdown = SettingsTab:Dropdown({
	Title = "Choose Weapon",
...
SettingsTab:Slider({
	...
	Min = 20,
	Max = 600,
	Value = _G.NearestFarmRadius or 150,
	Callback = function(value)
		_G.NearestFarmRadius = value;
	end
});
ResetSettingsButton = SettingsTab:Button({
...
SettingsTab:Section(" Speed & Jump Control");
SettingsTab:Toggle({
...
SettingsTab:Slider({
	...
	Min = 16,
	Max = 300,
	Value = _G.Settings.Setting["Custom Speed Val"] or 16,
	Callback = function(value)
...
SettingsTab:Slider({
	...
	Min = 100,
	Max = 1000,
	Value = _G.Settings.Setting["Custom Jump Pct"] or 100,
	Callback = function(value)
...
SpinPositionToggle = SettingsTab:Toggle({
	Title = "Spin Position",
...
FarmDistanceSlider = SettingsTab:Slider({
	Title = "Farm Distance",
	Step = 1,
	Value = {
		Min = 10,
		Max = 50,
		Value = _G.Settings.Setting["Farm Distance"]
	},
	Callback = function(value)
		_G.Settings.Setting["Farm Distance"] = value;
	end
});
PlayerTweenSpeedSlider = SettingsTab:Slider({
	Title = "Player Tween Speed",
	Step = 1,
	Value = {
		Min = 10,
		Max = 350,
		Value = _G.Settings.Setting["Player Tween Speed"]
	},
	Callback = function(value)
		_G.Settings.Setting["Player Tween Speed"] = value;
	end
});
BringMobToggle = SettingsTab:Toggle({
	Title = "Bring Mob",
	Value = true,
	Callback = function(state)
...
BringMobDropdown = SettingsTab:Dropdown({
	Title = "Bring Mob",
...
FastAttackMethodDropdown = SettingsTab:Dropdown({
...
SettingsTab:Section("Fast Attack Modes");
SettingsTab:Toggle({
...
AttackAuraToggle = SettingsTab:Toggle({
	Title = "Atatck Aura",
...
GraphicSettingSection = SettingsTab:Section("Graphic");
HideNotificationToggle = SettingsTab:Toggle({
...
HideDamageTextToggle = SettingsTab:Toggle({
...
BlackScreenToggle = SettingsTab:Toggle({
	Title = "Black Screen",
...
WhiteScreenToggle = SettingsTab:Toggle({
	Title = "White Screen",
...
MasterySettingsSection = SettingsTab:Section("Mastery Settings");
MasteryHealthSlider = SettingsTab:Slider({
	Title = "Mastery Health %",
	Step = 1,
	Value = {
		Min = 1,
		Max = 100,
		Value = _G.Settings.Setting["Mastery Health"]
	},
	Callback = function(value)
		_G.Settings.Setting["Mastery Health"] = value;
	end
});
DevilFruitParagraph = SettingsTab:Paragraph({
	Title = "Devil Fruit Skill"
});
MasteryFruitSkillZToggle = SettingsTab:Toggle({
	Title = "Skill Z",
	Value = true,
	Callback = function(state)
...
MasteryFruitSkillXToggle = SettingsTab:Toggle({
	Title = "Skill X",
	Value = true,
	Callback = function(state)
...
MasteryFruitSkillCToggle = SettingsTab:Toggle({
	Title = "Skill C",
	Value = true,
	Callback = function(state)
...
MasteryFruitSkillVToggle = SettingsTab:Toggle({
	Title = "Skill V",
...
MasteryFruitSkillFToggle = SettingsTab:Toggle({
	Title = "Skill F",
...
GunSkillParagraph = SettingsTab:Paragraph({
	Title = "Gun Skill"
});
MasteryGunSkillZToggle = SettingsTab:Toggle({
	Title = "Skill Z",
	Value = true,
	Callback = function(state)
...
MasteryGunSkillXToggle = SettingsTab:Toggle({
	Title = "Skill X",
	Value = true,
	Callback = function(state)
...
OthersSettingsSection = SettingsTab:Section("Others");
AutoObservationToggle = SettingsTab:Toggle({
...
AutoHakiToggle = SettingsTab:Toggle({
	Title = "Auto Haki",
...
AutoRejoinToggle = SettingsTab:Toggle({
	Title = "Auto Rejoin",
...
GunSwordSection = FarmingHopTab:Section(" Sea 1 Items");
GunSwordSection = FarmingHopTab:Section("World");
AutoSecondSeaToggle = FarmingHopTab:Toggle({
...
AutoThirdSeaToggle = FarmingHopTab:Toggle({
...
GunSwordSection = FarmingHopTab:Section("Fighting Style");
AutoSuperHumanToggle = FarmingHopTab:Toggle({
...
AutoDeathStepToggle = FarmingHopTab:Toggle({
...
AutoSharkmanKarateToggle = FarmingHopTab:Toggle({
...
AutoElectricClawToggle = FarmingHopTab:Toggle({
...
AutoDragonTalonToggle = FarmingHopTab:Toggle({
...
AutoGodHumanToggle = FarmingHopTab:Toggle({
...
GunSwordSection = FarmingHopTab:Section("Gun & Sword");
AutoGetSaberToggle = FarmingHopTab:Toggle({
...
AutoBuddySwordToggle = FarmingHopTab:Toggle({
...
AutoSoulGuitarToggle = FarmingHopTab:Toggle({
...
AutoRengokuToggle = FarmingHopTab:Toggle({
	Title = "Auto Rengoku",
	Desc = "Function Sea 2 Only",
...
AutoHallowScytheToggle = FarmingHopTab:Toggle({
...
AutoWardenSwordToggle = FarmingHopTab:Toggle({
...
FarmingHopTab:Section(" CDK / Yama / Tushita");
...
AutoGetYamaToggle = FarmingHopTab:Toggle({
	Title = "Auto Get Yama",
...
AutoGetYamaHopToggle = FarmingHopTab:Toggle({
...
AutoGetTushitaToggle = FarmingHopTab:Toggle({
...
AutoDragonTridentToggle = FarmingHopTab:Toggle({
...
AutoSharkSawToggle = FarmingHopTab:Toggle({
...
AutoPoleToggle = FarmingHopTab:Toggle({
	Title = "Auto Pole",
	Desc = "Function Sea 1 Only",
...
AutoDarkDaggerToggle = FarmingHopTab:Toggle({
...
StatsSection = StatsTab:Section("Stats");
StatsPointParagraph = StatsTab:Paragraph({
	Title = "Stats",
	Desc = "0"
});
spawn(function()
...
AutoAddMeleeStats = StatsTab:Toggle({
...
AutoAddDefenseStats = StatsTab:Toggle({
...
AutoAddSwordStats = StatsTab:Toggle({
...
AutoAddGunStats = StatsTab:Toggle({
	Title = "Add Gun Stats",
...
AutoAddDevilFruitStats = StatsTab:Toggle({
...
PointStats = 1;
StatsPointToAddSlider = StatsTab:Slider({
	Title = "Point",
	Step = 1,
	Value = {
		Min = 1,
...
RaidSection = RaidTab:Section("Raid");
...
-- Paragraph de status
local RaidStatusParagraph = RaidTab:Paragraph({
	Title = "Raid Status",
	Desc = "Desligado"
});
...
-- Chip dropdown
ChooseChipRaidDropdown = RaidTab:Dropdown({
...
AutoBuyChipToggle = RaidTab:Toggle({
	Title = " Auto Buy Chip",
...
AutoAwakeningToggle = RaidTab:Toggle({
	Title = "Auto Awaken",
...
PriceDevilFruitToUnstoreSlider = RaidTab:Slider({
	Title = "Price (Auto Unstore Fruit)",
	Value = {Min = 1, Max = 10000000, Value = _G.Settings.Raid["Price Devil Fruit"] or 1000000},
	Callback = function(value)
		_G.Settings.Raid["Price Devil Fruit"] = value;
		(getgenv()).SaveSetting();
	end
});
AutoUnstoreDevilFruitToggle = RaidTab:Toggle({
...
TeleportToLabButton = RaidTab:Button({
...
LawRaidSection = RaidTab:Section("Law Raid");
AutoLawRaidToggle = RaidTab:Toggle({
	Title = "Auto Law Raid",
...
RaceTabSection = RaceTab:Section("Race");
local PlaceV4List = {
	"Top Of GreatTree",
	"Timple Of Time",
	"Lever Pull",
...
SelectedPlaceDropdown = RaceTab:Dropdown({
...
TeleportToPlaceToggle = RaceTab:Toggle({
...
AutoBuyGearToggle = RaceTab:Toggle({
	Title = "Auto Buy Gear",
...
TweenToMirageIslandToggle = RaceTab:Toggle({
...
LookMoonAbilityToggle = RaceTab:Toggle({
...
AutoTrainToggle = RaceTab:Toggle({
	Title = "Auto Train",
...
TeleportToRaceDoorButton = RaceTab:Button({
...
BuyAcientQuestButton = RaceTab:Button({
	Title = "Buy Acient Quest",
	Callback = function()
		(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("UpgradeRace", "Buy");
	end
});
CombatTab:Section(" PvP Tools");
...
if not _IS_DUNGEON then
	...
	DungeonTab:Section("Dungeon World");
	...
	--   AUTO SKIP HUB
	-- ═══════════════════════════════════════════════
	DungeonTab:Section("Post-Dungeon");
	DungeonTab:Toggle({
...
local PvPPlayerDropdown = CombatTab:Dropdown({
	Title = "Select Player",
...
AutoTrialToggle = RaceTab:Toggle({
	Title = "Auto Trial",
...
AutoKillPlayerAfterTrialToggle = RaceTab:Toggle({
...
TeleportSection = TeleportTab:Section("Teleport");
TeleportToFirstSeaButton = TeleportTab:Button({
	Title = "Teleport To First Sea",
	Callback = function()
		(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("TravelMain");
	end
});
TeleportToSecondSeaButton = TeleportTab:Button({
	Title = "Teleport To Second Sea",
	Callback = function()
		(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("TravelDressrosa");
	end
});
TeleportToThirdSeaButton = TeleportTab:Button({
	Title = "Teleport To Third Sea",
	Callback = function()
		(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("TravelZou");
	end
});
TeleportIslandSection = TeleportTab:Section("Island");
ShopSection = ShopTab:Section("Shop");
AutoBuyLegendarySwordToggle = ShopTab:Toggle({
...
AutoBuyHakiColorToggle = ShopTab:Toggle({
...
AbilitiesShopSection = ShopTab:Section("Abilities");
BuyGeppoButton = ShopTab:Button({
	Title = "Buy Geppo",
	Desc = "$10,000",
	Callback = function()
...
BuyObservationHakiButton = ShopTab:Button({
...
ShopTab:Section(" Buy Fight Styles - Tween to NPC");
...
local function BuyFightStyleFull(styleName)
	...
	if not data then
		Library:Notify({Title = "OVERLORD Hub", Content = "Estilo nao encontrado: " .. tostring(styleName), Icon = "alert-triangle", Duration = 4});
		return;
	end;
	local plr = game.Players.LocalPlayer;
	local hrp = plr.Character and plr.Character:FindFirstChild("HumanoidRootPart");
	...
	Library:Notify({Title = "OVERLORD Hub", Content = "Compra enviada: " .. styleName, Icon = "check", Duration = 4});
end;
...
SwordShopSection = ShopTab:Section("Sword");
BuyCutlassButton = ShopTab:Button({
	Title = "Buy Cutlass",
	Desc = "$1,000",
	Callback = function()
...
BuyKatanaButton = ShopTab:Button({
	Title = "Buy Katana",
	Desc = "$1,000",
	Callback = function()
...
BuyIronMaceButton = ShopTab:Button({
	Title = "Buy Iron Mace",
	Desc = "$25,000",
	Callback = function()
...
BuyDualKatanaButton = ShopTab:Button({
...
BuyTripleKatanaButton = ShopTab:Button({
...
BuyDualHeadedBladeButton = ShopTab:Button({
...
BuyBisentoButton = ShopTab:Button({
	Title = "Buy Bisento",
	Desc = "$1,200,000",
	Callback = function()
...
BuySoulCaneButton = ShopTab:Button({
	Title = "Buy Soul Cane",
	Desc = "$1,000",
	Callback = function()
...
GunShopSection = ShopTab:Section("Gun");
BuySlingshotButton = ShopTab:Button({
	Title = "Buy Slingshot",
	Desc = "$5,000",
	Callback = function()
...
BuyMusketButton = ShopTab:Button({
	Title = "Buy Musket",
	Desc = "$8,000",
	Callback = function()
...
BuyFintlockButton = ShopTab:Button({
	Title = "Buy Flintlock",
	Desc = "$10,500",
	Callback = function()
...
BuyRefinedFintlockButton = ShopTab:Button({
...
BuyKabuchaButton = ShopTab:Button({
	Title = "Buy Kabucha",
	Desc = "B$1,500",
	Callback = function()
...
StatsShopSection = ShopTab:Section("Stats");
ResetStatsShopButton = ShopTab:Button({
	Title = "Reset Stats",
	Desc = "B$2,500",
	Callback = function()
...
RandomRaceShopButton = ShopTab:Button({
	Title = "Random Race",
	Desc = "B$3,000",
	Callback = function()
...
AccessoriesShopSection = ShopTab:Section("Accessories");
BuyBlackCapeButton = ShopTab:Button({
...
BuySwordsmanHatButton = ShopTab:Button({
...
BuyTomoeRingButton = ShopTab:Button({
...
SelectedTeleportIslandDropdown = TeleportTab:Dropdown({
	Title = "Choose Island",
...
AutoTeleportToIslandToggle = TeleportTab:Toggle({
					...
					if PortalIslands and PortalIslands[_G.SelectIsland] then
						...
						if target then
							...
							if hrp and (hrp.Position - destCF.p).Magnitude < 20 then
								-- Chegou! Para o loop
								_G.BypassTeleportActive = false;
								Library:Notify({Title = "OVERLORD Hub", Content = "Chegou em: " .. _G.SelectIsland, Icon = "map-pin", Duration = 4});
							end;
						end;
					end;
				end);
...
AutoTweenToIslandToggle = TeleportTab:Toggle({
	Title = "Tween To Island",
...
TeleportNpcSection = TeleportTab:Section("Npc");
...
SelectedNpcTeleport = TeleportTab:Dropdown({
	Title = "Choose Npc",
...
TeleportToNpcToggle = TeleportTab:Toggle({
...
_G.TweenNPC = false;
TweenToNpcToggle = TeleportTab:Toggle({
	Title = "Tween To Npc",
...
EspSection = EspTab:Section("Esp");
EspPlayerToggle = EspTab:Toggle({
	Title = "Esp Player",
...
EspDevilFruitToggle = EspTab:Toggle({
...
EspRealFruitToggle = EspTab:Toggle({
	Title = "Esp RealFruit",
...
EspSeaBeastToggle = EspTab:Toggle({
	Title = "Esp Sea Beast",
...
EspMonsterToggle = EspTab:Toggle({
	Title = "Esp Mob",
...
EspMirageIslandToggle = EspTab:Toggle({
...
EspKitsuneIslandToggle = EspTab:Toggle({
...
EspFrozenDimensionToggle = EspTab:Toggle({
...
EspPrehistoricIslandToggle = EspTab:Toggle({
...
DragonDojoTab:Section(" Dojo Quest - Belt Trainer");

DragonDojoTab:Paragraph({
...
DragonDojoSection = DragonDojoTab:Section("Dragon Dojo");
AutoFarmBlazeEmberToggle = DragonDojoTab:Toggle({
...
CraftVolcanicMagnetButton = DragonDojoTab:Button({
...
DragonDojoTab:Section("Draco Trial");
...
UpgradeDracoTrialToggle = DragonDojoTab:Toggle({
...
DracoV1Toggle = DragonDojoTab:Toggle({
	Title = "Auto Draco V1",
...
DracoV2Toggle = DragonDojoTab:Toggle({
	Title = "Auto Draco V2",
...
DracoV3Toggle = DragonDojoTab:Toggle({
	Title = "Auto Draco V3",
...
RelicDracoTrialToggle = DragonDojoTab:Toggle({
...
SeaEventTab:Section(" Sea Event - Setting Sail");

-- Barcos disponiveis
ChooseBoatDropdown = SeaEventTab:Dropdown({
	Title = "Choose Boat",
...
ChooseZoneDropdown = SeaEventTab:Dropdown({
...
local BoatSpeedSlider = SeaEventTab:Slider({
	Title = "Boat Speed",
...
SailSeaToggle = SeaEventTab:Toggle({
	Title = "Sail Sea",
...
SeaEventEnemiesSection = SeaEventTab:Section("Enemies Sea");
AutoFarmSharkToggle = SeaEventTab:Toggle({
...
AutoFarmPiranhaToggle = SeaEventTab:Toggle({
...
AutoFarmFishCrewMemberToggle = SeaEventTab:Toggle({
...
SeaEventBoatSection = SeaEventTab:Section("Enemies Sea (Boat)");
AutoFarmGhostShipToggle = SeaEventTab:Toggle({
...
AutoFarmPirateBrigadeToggle = SeaEventTab:Toggle({
...
AutoFarmPirateGrandBrigadeToggle = SeaEventTab:Toggle({
...
SeaEventBossSection = SeaEventTab:Section("Enemies Sea (Boss)");
AutoFarmTerrorsharkToggle = SeaEventTab:Toggle({
...
AutoFarmSeabeastsToggle = SeaEventTab:Toggle({
...
SeaStackSection = SeaStackTab:Section("Islands");
spawn(function()
	pcall(function()
		while wait(0.2) do
...
PrehistoricStatusSeaStackParagraph = SeaStackTab:Paragraph({
	Title = "Prehistoric Status",
	Desc = "N/A"
});
AutoSummonPrehistoricIslandToggle = SeaStackTab:Toggle({
...
TweenToPrehistoricIslandToggle = SeaStackTab:Toggle({
...
AutoKillLavaGolemToggle = SeaStackTab:Toggle({
...
FrozenStatusSeaStackParagraph = SeaStackTab:Paragraph({
	Title = "Frozen Status",
	Desc = "N/A"
});
AutoSummonFrozenDimensionToggle = SeaStackTab:Toggle({
...
TweenToFrozenDimensionToggle = SeaStackTab:Toggle({
...
BribeLeviathanStatusParagraph = SeaStackTab:Paragraph({
	Title = "Leviathan Status",
	Desc = "0"
});
BribeLeviathanButton = SeaStackTab:Button({
...
KitsuneStatusSeaStackParagraph = SeaStackTab:Paragraph({
	Title = "Kitsune Status",
	Desc = "N/A"
});
AutoSummonKitsuneIslandToggle = SeaStackTab:Toggle({
...
TweenToKitsuneIslandToggle = SeaStackTab:Toggle({
...
AutoCollectAzureEmberToggle = SeaStackTab:Toggle({
...
SetAzureEmberSlider = SeaStackTab:Slider({
	Title = "Set Azure Ember",
	Step = 1,
	Value = {
		Min = 1,
		Max = 25,
		Value = _G.Settings.SeaStack["Set Azure Ember"]
	},
	Callback = function(value)
...
AutoTradeAzureEmberToggle = SeaStackTab:Toggle({
...
MirageStatusSeaStackParagraph = SeaStackTab:Paragraph({
	Title = "Mirage Status",
	Desc = "N/A"
});
TweenToMirageIslandToggle = SeaStackTab:Toggle({
	Title = "Tween To Mirage Island",
...
SeaStackTab:Section("MIRAGE ISLAND");
			...
			if nightTime then
				for _, v in pairs(mystic:GetDescendants()) do
					if v:IsA("MeshPart") and v.Material == Enum.Material.Neon and v.BrickColor == BrickColor.new("Bright blue") then
						...
						task.wait(0.2);
						pcall(function()
							Library:Notify({Title = "OVERLORD Hub", Content = "Quest completa!", Icon = "bell", Duration = 6});
						end);
...
SeaBeastSeaStackSection = SeaStackTab:Section("Sea Beasts");
AutoAttackSeaBeastsToggle = SeaStackTab:Toggle({
...
SettingSeaSection = SeaSettingsTab:Section("Setting Sea");
LightningToggle = SeaSettingsTab:Toggle({
	Title = "Lightning",
...
IncreaseSpeedBoatToggle = SeaSettingsTab:Toggle({
...
NoClipRockToggle = SeaSettingsTab:Toggle({
	Title = "No Clip Rock",
...
SettingSeaSection = SeaSettingsTab:Section("Tools");
UseDevilFruitSkillToggle = SeaSettingsTab:Toggle({
...
UseMeleeSkillToggle = SeaSettingsTab:Toggle({
...
UseSwordSkillToggle = SeaSettingsTab:Toggle({
...
UseGunSkillToggle = SeaSettingsTab:Toggle({
	Title = "Use Gun Skill",
	Value = true,
	Callback = function(state)
...
DevilFruitSkillSection = SeaSettingsTab:Section("Devil Fruit Skill");
DevilFruitZSkillToggle = SeaSettingsTab:Toggle({
...
DevilFruitXSkillToggle = SeaSettingsTab:Toggle({
...
DevilFruitCSkillToggle = SeaSettingsTab:Toggle({
...
DevilFruitVSkillToggle = SeaSettingsTab:Toggle({
...
DevilFruitFSkillToggle = SeaSettingsTab:Toggle({
...
MeleeSkillSection = SeaSettingsTab:Section("Melee Skill");
MeleeZSkillToggle = SeaSettingsTab:Toggle({
	Title = "Melee Z Skill",
	Value = true,
	Callback = function(state)
...
MeleeXSkillToggle = SeaSettingsTab:Toggle({
	Title = "Melee X Skill",
	Value = true,
	Callback = function(state)
...
MeleeCSkillToggle = SeaSettingsTab:Toggle({
	Title = "Melee C Skill",
	Value = true,
	Callback = function(state)
...
MeleeVSkillToggle = SeaSettingsTab:Toggle({
	Title = "Melee V Skill",
	Value = true,
	Callback = function(state)
...
LocalPlayerSection = LocalPlayerTab:Section("Local Player");
AutoActiveRaceV3Toggle = LocalPlayerTab:Toggle({
...
AutoActiveRaceV4Toggle = LocalPlayerTab:Toggle({
...
WalkOnWaterToggle = LocalPlayerTab:Toggle({
	Title = "Walk On Water",
...
NoClipPlayerToggle = LocalPlayerTab:Toggle({
	Title = "No Clip",
...
FruitSection = FruitTab:Section("Fruit");
AutoRandomFruitToggle = FruitTab:Toggle({
...
StoreRarityFruitDropdown = FruitTab:Dropdown({
...
AutoStoreFruitToggle = FruitTab:Toggle({
...
FruitNotification = FruitTab:Toggle({
...
TeleportToFruitToggle = FruitTab:Toggle({
...
TweenToFruitToggle = FruitTab:Toggle({
...
GrabFruitButton = FruitTab:Button({
	Title = "Grab Fruit",
	Callback = function()
		for i, v in pairs(game.Workspace:GetChildren()) do
			if v:IsA("Tool") then
...
VisualSection = FruitTab:Section("Visual");
function rainFruit()
...
RainFruitButton = FruitTab:Button({
	Title = "Rain Fruit",
	Callback = function()
		rainFruit();
	end
});
MiscSection = MiscTab:Section("Misc");
JoinPiratesTeamButton = MiscTab:Button({
	Title = "Join Pirates Team",
	Callback = function()
		(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("SetTeam", "Pirates");
	end
});
JoinMarinesTeamButton = MiscTab:Button({
	Title = "Join Marines Team",
	Callback = function()
		(game:GetService("ReplicatedStorage")).Remotes.CommF_:InvokeServer("SetTeam", "Marines");
	end
});
CodeSection = MiscTab:Section("Codes");
local codeList = {
	"KITTGAMING",
	"ENYU_IS_PRO",
	"FUDD10",
...
local RedeemAllCodesButton = MiscTab:Button({
...
GraphicMiscSection = MiscTab:Section("Graphic");
function boostFps()
	local I = true;
	local e = game;
	local K = e.Workspace;
...
FpsBoostButton = MiscTab:Button({
	Title = "Fps Boost",
	Callback = function()
		boostFps();
	end
});
RemoveFogButton = MiscTab:Button({
	Title = "Remove Fog",
	Callback = function()
...
RemoveLavaButton = MiscTab:Button({
	Title = "Remove Lava",
	Callback = function()
...
ServerTabSection = ServerTab:Section("Server");
-- Informacoes de Performance no Status Server
local _FpsParagraph = ServerTab:Paragraph({
	Title = "FPS",
	Desc = "0",
	Image = "monitor",
	ImageSize = 20
...
local _PingParagraph = ServerTab:Paragraph({
	Title = "Ping",
	Desc = "0",
	Image = "signal",
	ImageSize = 20
...
RejoinServerButton = ServerTab:Button({
	Title = "Rejoin Server",
	Callback = function()
		(game:GetService("TeleportService")):Teleport(game.PlaceId);
	end
});
ServerHopButton = ServerTab:Button({
	Title = "Server Hop",
	Callback = function()
		local module = (loadstring(game:HttpGet("https://raw.githubusercontent.com/raw-scriptpastebin/FE/main/Server_Hop_Settings")))();
		module:Teleport(game.PlaceId);
...
JobIdParagraph = ServerTab:Paragraph({
	Title = "Job ID",
	Desc = game.JobId,
	Buttons = {
		{
...
JoinJobIdButton = ServerTab:Button({
	Title = "Join Job ID",
	Callback = function()
		(game:GetService("TeleportService")):TeleportToPlaceInstance(game.PlaceId, _G.JobId);
	end
});
StatusServerSection = ServerTab:Section("Status");
MoonServerParagraph = ServerTab:Paragraph({
	Title = "Moon Server",
	Desc = "N/A"
});
KitsuneStatusParagraph = ServerTab:Paragraph({
	Title = "Kitsune Status",
	Desc = "N/A"
});
FrozenStatusParagraph = ServerTab:Paragraph({
	Title = "Frozen Status",
	Desc = "N/A"
});
MirageStatusParagraph = ServerTab:Paragraph({
	Title = "Mirage Status",
	Desc = "N/A"
});
HakiDealerStatusParagraph = ServerTab:Paragraph({
	Title = "Haki Dealer Status",
	Desc = "N/A"
});
PrehistoricStatusParagraph = ServerTab:Paragraph({
	Title = "Prehistoric Status",
	Desc = "N/A"
});
spawn(function()
...
local _seaStatusParagraph = ServerTab:Paragraph({
	Title = "SEA ATUAL",
	Desc = "Detectando..."
});
local _serverTimeParagraph = ServerTab:Paragraph({
	Title = "TEMPO DE SERVIDOR",
	Desc = "N/A"
});
local _fodStatusParagraph = ServerTab:Paragraph({
	Title = "FIRST OF DARKNESS",
	Desc = "N/A"
});
local _chaliceStatusParagraph = ServerTab:Paragraph({
	Title = "GOD CHALICE",
	Desc = "N/A"
});
local _raidBossStatusParagraph = ServerTab:Paragraph({
	Title = "RAID BOSS",
	Desc = "N/A"
});
local _pirateRaidStatusParagraph = ServerTab:Paragraph({
	Title = "PIRATES RAID",
	Desc = "N/A"
});
local _factoryStatusParagraph = ServerTab:Paragraph({
	Title = "FACTORY",
	Desc = "N/A"
});
local _jobIdParagraph = ServerTab:Paragraph({
	Title = "JOB ID",
	Desc = "Em breve"
});
...
HoldAndSkillTab:Section("Cấu Hình Kỹ Năng - Chọn kỹ năng dùng trong farm");

HoldAndSkillTab:Paragraph({
...
HoldAndSkillTab:Section("Kỹ Năng Riêng Lẻ");
